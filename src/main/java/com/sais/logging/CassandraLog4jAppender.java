...
public class CassandraLog4jAppender extends AppenderSkeleton {
	 ...
	 * Constructor.
	 */
	public CassandraLog4jAppender() throws UnknownHostException {
	...
	/**
	 * Commits to database all the logging events stored in the buffer using a
	 * batch query.
	 */
	private void flush() {
	...
	/**
	 * Adds to the specified {@link Insert} statement the column defined by the
	 * specified name and value only if such value is not {@code null}.
	 * 
	 * @param insert the {@link Insert} statement
	...
	/**
	 * Adds to the specified {@link Batch} statement the {@link Insert}
	 * statement representing the specified {@link LoggingEvent}.
	 * 
	 * @param batch the {@link Batch} statement to be filled
	 * @param event the {@link LoggingEvent} to be added
	 */
	private void batch(Batch batch, LoggingEvent event) {
